...
export default function BottomBar({count} : {count: string}) {
    ...
    return (
        <Flex px={"3"} pos={"fixed"} bottom={"0px"} bgColor={mainBackgroundColor} alignItems={"center"} justifyContent={"space-between"} width='100%' height='70px' borderTopWidth={1} borderTopColor={borderColor} display={['flex', 'flex', 'flex', 'none', 'none']}>
