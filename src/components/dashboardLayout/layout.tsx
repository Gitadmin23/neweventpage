        ...
        <Flex w={"100vw"} h={"100vh"} pos={"fixed"} inset={"0px"} color={headerTextColor} bgColor={mainBackgroundColor} >
            ...
            <Flex w={"full"} height={"100vh"} pos={"relative"} flexDirection={"column"} >
                ...
                <Flex w={"full"} h={"full"} pos={"relative"} >
                    <Flex w={"full"} pos={"absolute"} overflowY={"auto"} bottom={frame ? "0px" : ["0px", "0px", "0px"]} top={frame ? "0px" : ["76px", "76px", "76px", "0px", "0px"]}  insetX={"0px"} >
                        {children}
                    </Flex> 
                ...
                {!frame && (
                    <Flex w={"full"} pos={"relative"} h={["70px", "70px", "0px", "0px", "0px"]}  >
