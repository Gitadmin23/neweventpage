        ...
        <Flex w={"100vw"} h={"100vh"} color={headerTextColor} bgColor={mainBackgroundColor} >
            ...
            <Flex w={"full"} height={"100vh"} pos={"relative"} flexDirection={"column"} >
                ...
                <Flex w={"full"} pos={"relative"} h={"full"} >
                    <Flex w={"full"} pos={"absolute"} bgColor={mainBackgroundColor} overflowY={"auto"} bottom={["70px", "70px", "70px", "0px", "0px"]} top={(pathname?.includes("create") || pathname?.includes("details")) ? "0px" : ["76px", "76px", "76px", "0px", "0px"]}  insetX={"0px"} >
                        {children}
                    </Flex>
                </Flex>
                {!frame && (
