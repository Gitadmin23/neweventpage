...
export default function DetailsPage(props: IEventType | any) {
    const {
        isOrganizer,
        eventMemberRole,
        eventName,
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                ...
                                {isAdmin && <OrganizeBtn {...props} />}
                                {isOrganizer && <VolunteerBtn {...props} />}
                            </Flex>
                        </Flex>
                    </Flex>
